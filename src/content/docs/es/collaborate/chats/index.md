...
![docs chat launch](/assets/docs-chat-launch.jpg)

## Cómo funciona

Just like documents and files, Chats are [Objects](../../create/objects/) that have their own dedicated [Type](/es/organize/types/). This means that a Chat:

* Lives in the Types section of the Sidebar under 'Chat'.
* Can have its own [Properties](/es/organize/properties/).
* Can be organized into [Views](/es/organize/views/), [Queries](/es/organize/queries/), and [Collections](/es/organize/collections/).
* Can be added as a [Widget](/es/basics/sidebar/widgets/) to the Sidebar.
...
![docs chat create](/assets/docs-chat-create.jpg)
...
A single Channel can hold multiple Chats. You can start topic-specific conversations right where the work happens and keep them organized by using [Views](/es/organize/views/).
...
![docs chats multiple](/assets/docs-chats-multiple.jpg)
...
![docs chat widget](/assets/docs-chat-widget.jpg)
...
![docs chats using](/assets/docs-chats-using.jpg)
...
* Becomes a [File Object](/es/create/files-and-media/) you can find later
...
A temporary **Unread** section appears automatically when new messages arrive in any Chat. As you catch up, the section shrinks and eventually disappears. This section also displays notifications from [Discussions](/es/collaborate/discussions/). Learn more in the [Sidebar](/es/basics/sidebar/sections/) section.

![docs chats unread](/assets/docs-chats-unread.jpg)
...
These settings are per-Chat and override Channel-level defaults. See [Notifications](/es/settings/channel-settings/#notificaciones) for the full picture.
...
See [Channels](/es/basics/channels/#tu-página-de-inicio) for more details.

![home chat](/assets/home-chat.png)
...
For one-on-one conversations with others, use **Direct Channels** — private chats between two people, with no admin or hierarchy. See [Direct Channels](/es/collaborate/chats/direct-channels/) for more information.
...
:::note
**For Object-specific feedback, use Discussions instead of Chat.** Discussions live on the Object and stay attached forever. Chats are for cross-Object conversations and stream-of-consciousness collaboration. See [Discussions](/es/collaborate/discussions/).
:::
