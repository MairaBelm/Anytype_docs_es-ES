...
![docs tabs](/assets/docs-tabs.jpg)
...
You can create your own [focus mode](../../basics/sidebar/#modo-de-concentración) with the 'Toggle Vault & Channel Sidebar' [keyboard shortcut ](/es/advanced/settings/keyboard-shortcuts/)to hide both sidebars at the same time. This mitigates distractions and stops you from navigating away from your active tab.
