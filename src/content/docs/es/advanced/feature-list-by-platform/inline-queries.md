...
![inline list 1](/assets/inline-list-1.png)
...
These changes are saved to the inline block, not back to the source Query.![inline list](/assets/inline-list.png)### Dynamic filter values

Inline Queries pair beautifully with [dynamic filter values](/es/advanced/feature-list-by-platform/advanced-filters/). Two especially useful values:
