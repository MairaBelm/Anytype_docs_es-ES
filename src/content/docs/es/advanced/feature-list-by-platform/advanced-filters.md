...
La barra de filtro básico muestra condiciones simples unidas por AND. La barra de filtro avanzado muestra tu lógica completa, incluidos los agrupamientos OR, las reglas anidadas y los indicadores visuales de cómo se combinan las condiciones.![unknown 1](/assets/unknown-1.png)## Crear condiciones
...
* **Valor**: con qué comparar (un valor específico, una lista o un [valor dinámico](/es/advanced/feature-list-by-platform/advanced-filters/#dynamic-filter-values))
...
2. Click **Delete**.![advanced filters 1](/assets/advanced-filters-1.png)### Dynamic filter values
...
**This Object** works inside [Inline Lists](/es/advanced/feature-list-by-platform/inline-queries/) — it scopes the inline Query/Collection to whatever Object is hosting it.
