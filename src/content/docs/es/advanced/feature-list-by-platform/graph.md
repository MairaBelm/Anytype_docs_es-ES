...
The Graph icon (a small node-and-edge symbol) appears at the top of every Object. Click it to switch to Graph view.![graph](/assets/graph.png)You can also press the keyboard shortcut listed in your shortcut settings to open Graph from any Object.
