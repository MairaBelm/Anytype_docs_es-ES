...
1. In the editor, type `/` to open the menu and type the name of your desired Embed—[full list here](/es/advanced/feature-list-by-platform/embeds/#supported-embed-types). Or scroll down to the Embeds section.
...
![image 12 1](/assets/image-12-1.png)
