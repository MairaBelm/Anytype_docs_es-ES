...
En la aplicación de escritorio, haz clic en el botón **?** (Ayuda) que aparece en la esquina inferior derecha de la barra lateral, y luego en «[Únete a nuestra comunidad](https://community.anytype.io/invites/sig5xTU4ZZ)».![join comminuty](/assets/join-comminuty.png)También puedes ir a la barra de menús de la parte superior de la ventana, debajo de la barra de título, y hacer clic en `Ayuda > Informar de un fallo`.
...
[https://community.anytype.io/c/bug-report/7](https://community.anytype.io/c/bug-report/7)
...
[https://community.anytype.io/c/any-help/8](https://community.anytype.io/c/any-help/8)
...
[https://community.anytype.io/c/any-talk/10](https://community.anytype.io/c/any-talk/10)
