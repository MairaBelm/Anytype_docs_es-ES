...
Click and drag the 'handle' to the left of each block and move it to your desired location. [Learn more](../creation/blocks#columns).![docs blocks columns](/assets/docs-blocks-columns.gif)</details>
...
Anytype does not have access to your account in any way, thus we do not have your Key and cannot recover it for you. However you may be able to recover it on your own, [see here for more details](/es/basics/key/#que-ocurre-si-pierdes-la-clave).
...
* Columns
* Inline LaTeX
* [inline-queries.md](../advanced/feature-list-by-platform/inline-queries.md)
* Kanban, Calendar, and Graph Views
* [formulas.md](../advanced/feature-list-by-platform/formulas.md)
* [embeds.md](../advanced/feature-list-by-platform/embeds.md)
* [custom-css.md](../advanced/feature-list-by-platform/custom-css.md)
* [storage-location.md](../advanced/feature-list-by-platform/storage-location.md)
* [graph.md](../advanced/feature-list-by-platform/graph.md) & Flow
...
Vaults created before version 0.44.0 have an Entry Space. You are free to delete this channel if no longer needed, or you can migrate your data to a different channel by using the [import-and-export](../data/import-and-export/README.md) feature.
