...
* [Propiedades](/es/organize/properties/) para definirlos, como dirección, fecha de creación y etiquetas.
* [Vistas](/es/organize/views/) para organizarlos, como un calendario con todos los eventos importantes.
* [Plantillas](/es/organize/templates/) para normalizarlos, como un álbum de fotos insertado en todas las vacaciones.
...
Puedes ver todos tus tipos en los [ajustes del canal](/es/settings/channel-settings/), en la sección **Modelo de contenido**. Haz clic en el botón «Nuevo» para añadir un tipo nuevo a tu espacio.
...
1. Abre el tipo desde la [barra lateral](/es/basics/sidebar/) y haz clic en **Editar tipo** en la parte superior derecha.
2. Cuando tengas abierto un [objeto](/es/create/objects/), haz clic en el botón de tres puntos de la esquina superior derecha y selecciona la opción **Ajustes de tipo**.
...
* modificar el [diseño del objeto](/es/create/objects/formats/#formato-de-página).
...
Para cambiar el tipo de varios objetos a la vez, es mejor usar [vistas](/es/organize/views/). Encontrarás más detalles [aquí](/es/organize/views/#edición-de-objetos-en-lote).
...
Los tipos son particulares del canal en el que se crean. Si quieres que cierto tipo esté también en otros espacios, consulta [Importar y exportar](/es/data/import-and-export/). Por el momento, no puedes tener tipos comunes y sincronizados entre espacios, ya que están separados por diferentes claves de cifrado.
