...
Drag a file onto the editor to insert it. Each file becomes a [File Object](/create/files-and-media/) you can find and reference elsewhere.
...
See [Embeds](/advanced/feature-list-by-platform/embeds/) for the full list — LaTeX, YouTube, Miro, Mermaid, Figma, Excalidraw, and more.
