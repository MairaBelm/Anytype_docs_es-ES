...
1. Create a [Collection](/organize/collections/) or open an existing one.
...
If you are worried about storage in your space, there is a [Cleanup section in the Bin](/organize/deletion/) that suggests files to delete which likely no longer serve a purpose in your space.
