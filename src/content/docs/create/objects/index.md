...
* **Create Button** — when clicking the 'Create' button, you’ll immediately create a new Object. The default [Type](/organize/types/) that is used for your Objects is set from your [Channel Settings](/settings/channel-settings/)—by default it is 'Page'.
...
You can create an Object directly from the Types section of the Sidebar by hovering over the [Type](/organize/types/) and clicking on the 'plus' button. Here you will also find Queries and Collections. Please note:

* If this section is not showing, please see [Manage Sections](/basics/sidebar/sections/#manage-sections) to reveal it.
...
Objects created this way will leave a block link on the page and set a [backlink](/create/links/) to the newly created object.
...
2. Click **Turn into object** and select your desired [Type](/organize/types/).
...
Alternatively you can set this in the [Channel Settings](/settings/channel-settings/).
...
:::note
**Use Views to make sense of your Objects.** Because there is no folder hierarchy for Objects, the best way to stay organized is to use [Views](/organize/views/).
:::
