...
* Count of Objects of each type![formulas](/assets/formulas.png)## Where Formulas appear
...
The result displays in the column footer and updates as your data changes.![formulas 1](/assets/formulas-1.png)## Available formulas
...
For more complex calculations, export the data to CSV and process it externally — or use the [Anytype Agents Skill](/advanced/feature-list-by-platform/anytype-agents-skill/) to run scripts against your data.
