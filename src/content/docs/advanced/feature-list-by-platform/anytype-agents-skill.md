...
Anytype already exposes a [Local API](/advanced/feature-list-by-platform/local-api/) for direct integration. The Skill is a layer above that — it bundles the API into ready-made functions an AI agent can use without you having to teach it the protocol.
...
* A [Local API key](/advanced/feature-list-by-platform/local-api/) generated in **Vault Settings > API Keys**
...
* [Local API](/advanced/feature-list-by-platform/local-api/) — the underlying interface
* [API Keys](/settings/vault-settings/) — managing keys in Vault Settings
