...
The basic filter bar shows simple conditions joined by AND. The advanced filter bar shows your full logic — including OR groupings, nested rules, and visual indicators of how conditions combine.![unknown 1](/assets/unknown-1.png)## Building conditions
...
* **Value** — what to compare against (a specific value, a list, or a [dynamic value](/advanced/feature-list-by-platform/advanced-filters/#dynamic-filter-values))
...
**This Object** works inside [Inline Lists](/advanced/feature-list-by-platform/inline-queries/) — it scopes the inline Query/Collection to whatever Object is hosting it.
