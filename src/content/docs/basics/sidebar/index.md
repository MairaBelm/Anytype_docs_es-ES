...
1. [Channel List](/basics/channels/) — all of the spaces you are part of
2. [Vault Settings](/settings/vault-settings/) — ability to manage your account
3. [Keyboard Shortcuts](/advanced/settings/keyboard-shortcuts/) — to customize your shortcuts
...
Each section can be hidden, reordered, or fine-tuned. See [Widgets](/basics/sidebar/widgets/) and [Sections](/basics/sidebar/sections/) for details.
