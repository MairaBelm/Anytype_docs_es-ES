...
Just like documents and files, Chats are [Objects](/create/objects/) that have their own dedicated [Type](/organize/types/). This means that a Chat:

* Lives in the Types section of the Sidebar under 'Chat'.
* Can have its own [Properties](/organize/properties/).
* Can be organized into [Views](/organize/views/), [Queries](/organize/queries/), and [Collections](/organize/collections/).
* Can be added as a [Widget](/basics/sidebar/widgets/) to the Sidebar.
...
A single Channel can hold multiple Chats. You can start topic-specific conversations right where the work happens and keep them organized by using [Views](/organize/views/).
...
* Becomes a [File Object](/create/files-and-media/) you can find later
...
A temporary **Unread** section appears automatically when new messages arrive in any Chat. As you catch up, the section shrinks and eventually disappears. This section also displays notifications from [Discussions](/collaborate/discussions/). Learn more in the [Sidebar](/basics/sidebar/sections/) section.
...
These settings are per-Chat and override Channel-level defaults. See [Notifications](/settings/channel-settings/#notifications) for the full picture.
...
See [Channels](/basics/channels/#choosing-a-home) for more details.
...
For one-on-one conversations with others, use **Direct Channels** — private chats between two people, with no admin or hierarchy. See [Direct Channels](/collaborate/chats/direct-channels/) for more information.
...
:::note
**For Object-specific feedback, use Discussions instead of Chat.** Discussions live on the Object and stay attached forever. Chats are for cross-Object conversations and stream-of-consciousness collaboration. See [Discussions](/collaborate/discussions/).
:::
