...
Los ajustes del canal contienen todas las configuraciones de un [canal](../basics/channels.md): su nombre e icono, quién tiene acceso, cómo se comportan las notificaciones, qué ven los miembros cuando entran y otros detalles. Hay dos formas de abrir los ajustes del canal:
...
Gestiona el acceso de otras personas al canal. Los usuarios de un espacio compartido se denominan miembros del espacio, y su nivel de acceso depende de su función. Encontrarás más información sobre los espacios compartidos en [Colaboración](../collaborate/collaboration.md).
...
Los miembros de un espacio pueden tener distintas funciones, cada una con distintos permisos. Comprueba con regularidad la sección de miembros para asegurarte de que todo el mundo tiene los permisos correctos. Encontrarás más detalles en [Funciones de los miembros](../collaborate/collaboration.md#funciones-de-los-miembros).
...
En esta sección podrás invitar a tu espacio a otras personas y definir sus permisos. Para entender cómo funciona, consulta [Colaboración](../collaborate/collaboration.md "mention").
...
Puedes ver todos los detalles en [Tipos](../organize/types.md).
...
Puedes ver todos los detalles en [Propiedades](../organize/properties.md).
