...
1. [Lista de canales](../channels.md), con todos los espacios de los que formas parte.
2. [Ajustes del arca](../../settings/vault-settings.md), donde puedes gestionar tu cuenta.
...
* activar la preferencia de mostrarla y ocultarla automáticamente en los [ajustes del arca](../../settings/vault-settings.md "mention").
...
{% hint style="info" %}
**Ancla una consulta, no solo objetos estáticos.** Las consultas ancladas, como «Tareas en las que Estado = En curso» o «Notas que se han Modificado esta semana», funcionan como [widgets](widgets.md "mention") dinámicos: se actualizan según van cambiando los datos.
{% endhint %}
